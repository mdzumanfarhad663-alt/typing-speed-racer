...
export type ContentFieldType = "text" | "textarea" | "list" | "linklist";
...
type ChartLinkDefault = { label: string; href: string };

const JODI_CHART_LINKS_DEFAULT: ChartLinkDefault[] = [
...
const PANEL_CHART_LINKS_DEFAULT: ChartLinkDefault[] = [
...
const OTHER_JODI_CHART_LINKS_DEFAULT: ChartLinkDefault[] = [
...
const OTHER_PANEL_CHART_LINKS_DEFAULT: ChartLinkDefault[] = [
...
export const SECTION_CONFIG: SectionConfigEntry[] = [
  ...
  },
  {
    ...
    styleSlots: [
      ...
      { key: "ankBox", label: "Ank table", default: { backgroundColor: "#f5fffa", textColor: "#000000", borderColor: "orange", borderWidth: "3px", borderStyle: "solid", fontWeight: "700", fontStyle: "italic", fontSize: "17px" } },
  ...
  },
  {
    ...
    contentFields: [
      ...
      { key: "jodiLinks", label: "Jodi chart links", type: "linklist", default: JSON.stringify(JODI_CHART_LINKS_DEFAULT) },
      { key: "panelLinks", label: "Panel chart links", type: "linklist", default: JSON.stringify(PANEL_CHART_LINKS_DEFAULT) },
      { key: "otherJodiLinks", label: "Other jodi chart links", type: "linklist", default: JSON.stringify(OTHER_JODI_CHART_LINKS_DEFAULT) },
      { key: "otherPanelLinks", label: "Other panel chart links", type: "linklist", default: JSON.stringify(OTHER_PANEL_CHART_LINKS_DEFAULT) },
    ],
  },
  {
  ...
  },
  {
    ...
    styleSlots: [
      ...
      { key: "nameText", label: "Name", default: {} },
      { key: "resultText", label: "Result", default: {} },
      { key: "timeText", label: "Time", default: { textColor: "#dc2626" } },
    ],
